...
export class AppComponent {
  ...
  public inboxData: { [key: string]: Object }[] = [
    {
      id: '1',
      text: 'Albert Lives',
      subject: 'Business dinner invitation',
      message: 'Hello Uta Morgan,',
    },
    {
      id: '2',
      text: 'Ila Russo',
      subject: 'Opening for Sales Manager',
      message: 'Hello Jelani Moreno,',
    },
    {
      id: '3',
      text: 'Garth Owen',
      subject: 'Application for Job Title',
      message: 'Hello Ila Russo,',
    },
    {
      id: '4',
      text: 'Ursula Patterson',
      subject: 'Programmer Position Application',
  ...
  public draftsData: { [key: string]: Object }[] = [
    {
      id: '21',
      text: 'Chaim Barber',
      subject: 'We launched new Product!',
      message: 'Hello Cameran Roth,',
    },
    {
      id: '22',
      text: 'Lara Knox',
      subject: 'Request for meeting appointment email',
      message: 'Hello Mona Bates,',
    },
    {
      id: '23',
      text: 'Igor Mccoy',
    ...
    },
    {
      ...
      text: 'Patricia Boyle',
      subject: 'Sales Team',
      message: 'Hello Amelia Curtis,',
    },
    {
      id: '25',
      text: 'Zachery Peters',
      subject: 'Today’s meeting schedule',
      message: 'Hi Leslie Juarez,',
    },
  ];
  public deleteData: { [key: string]: Object }[] = [
    {
      ...
      message: 'Dear Kerry Best,',
    },
    {
      id: '32',
      text: 'Cameran Newman',
      subject: 'Business appointment request',
      message: 'Hello Mona Bates,',
    },
    {
      id: '33',
    ...
    },
    {
      id: '34',
      text: 'Leo Cooley',
      subject: 'Apology Email for Wrong Order',
      message: 'Hi Athena Mcintosh,',
    },
    {
      id: '35',
      text: 'Halee Lindsey',
      subject: 'Apology for late response email',
      message: 'Hi Fletcher Beck,',
    },
  ];
  public outBoxData: { [key: string]: Object }[] = [
    ...
    },
    {
      ...
      message: 'Hello Gail Pierce,',
    },
    {
      id: '44',
      text: 'Xanthus Harmon',
      subject: 'Performance appraisal announcement',
      message: 'Dear Clare Heath,',
    },
    {
      id: '45',
      text: 'Cheyenne Cline',
